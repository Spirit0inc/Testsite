...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && $_POST['action'] === 'send_lead') {
    ...
    if ($selected_route) {
        ...
        $calculated_price = max($cost_by_weight, $cost_by_volume);
        ...
        <body style='font-family: Arial, sans-serif;'>
            ...
            <table style='border-collapse: collapse; width: 100%;'>
                ...
                <tr><td style='padding: 8px; background: #f5f5f5;'><strong>Направление:</strong></td><td>{$selected_route['name']}</td></tr>
                <tr><td style='padding: 8px; background: #f5f5f5;'><strong>Вес:</strong></td><td>$weight кг</td></tr>
